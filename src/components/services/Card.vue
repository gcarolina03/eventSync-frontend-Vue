	...
	<div
		...
		<div class="p-5">
			...
			<div class="text-gray-600 mb-4">
				...
				<div v-if="props.data.latitude != undefined && props.data.longitude != undefined" class="group inline-flex cursor-pointer text-sm ml-2 relative text-gray-600 font-bold rounded-lg">
					...
					<div class="opacity-0 flex items-center justify-center bg-white rounded-lg p-2 absolute group-hover:opacity-100 bottom-0 ml-8 pointer-events-none z-[10] w-52">
						<Maps :latitude="props.data.latitude" :longitude="props.data.longitude" />
					</div>
				</div>
			</div>
